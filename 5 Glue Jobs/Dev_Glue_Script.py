...
## @type: DataSource
## @args: [database = "a6", table_name = "dev", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "a6", table_name = "dev", transformation_ctx = "datasource0")
## @type: ApplyMapping
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://aiops-a6/data/dev"}, format = "json", transformation_ctx = "datasink2"]
## @return: datasink2
## @inputs: [frame = applymapping1]
datasink2 = glueContext.write_dynamic_frame.from_options(frame = processed_tweets, connection_type = "s3", connection_options = {"path": "s3://aiops-a6/data/dev"}, format = "json", transformation_ctx = "datasink2")
job.commit()